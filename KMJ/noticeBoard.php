...
?>
    ...
    <div class="content_wrap">  
        ...
        <div class="content_banner">
            <p class="banner_text">공지사항 게시판</p>
        </div>
        <!--공지사항 + 게시글 구역-->
            ...
            <table width="100%" class="main_table">
                ...
                for($i=$start;$i<$start+$scale && $i < $total_record; $i++){
                    ...
                    <tr class="notice">
                        ...
                        <td class="title"><a style="color: black;" href="viewNotice.php?num=<?=$num?>&page=<?=$page?>"><?=$subject?></a></td>
                ...
                if ($total_page>=2&& $page >= 2){
                    $new_page = $page - 1;
                    echo "<li><a class='pageMenu' href='noticeBoard.php?page=$new_page' style='color:black'>이전</a></li>";
                } else
                ...
                for ($i=1; $i<=$total_page;$i++){
                    if ($page == $i && $i!=0) // 현재 페이지 번호 링크 안함
                        ...
                        echo "<li class='pageMenu'><a href='noticeBoard.php?page=$i' style='color:black'>$i</a></li>";
                }
                if ($total_page>=2 && $page != $total_page) {
                    $new_page = $page + 1;
                    echo "<li class='pageMenu'><a href='noticeBoard.php?page=$new_page' style='color:black'>다음</a></li>";    
                } else
                    echo "<li class='pageMenu'>&nbsp;</li>";
?>  
                </ul>    <!-- 페이지 번호 매김 끝-->
                <ul class="buttons" id="page2">  
                    <li>&nbsp;</li>
                    <li><button onclick="location.href='noticeBoard.php?page=<?=$page?>'">목록</button></li>
